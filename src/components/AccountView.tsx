  ...
  if (!currentUser) {
    return (
      <div className="h-screen bg-background flex items-center justify-center">
        <p className="text-muted-foreground">Zaloguj się aby zobaczyć profil</p>
      </div>
    )
  }
            ...
            <div className="flex flex-col items-center space-y-4">
              <div className="relative">
                <Avatar className="w-24 h-24">
                  <AvatarImage src={currentUser.profileImage || currentUser.avatar} alt={currentUser.name} />
              ...
              <div className="text-center space-y-2">
                ...
                <div className="flex items-center justify-center gap-4 text-sm text-muted-foreground">
                  ...
                  <div className="flex items-center gap-1">
                    <Calendar size={14} />
                    Dołączył {new Date(currentUser.createdAt).toLocaleDateString('pl-PL', { year: 'numeric', month: 'long' })}
                  </div>
                </div>
              </div>
            </div>
          ...
          <Card>
            <CardContent className="p-4 text-center">
              <div className="space-y-2">
                ...
                <div className="text-xs text-muted-foreground">Polubione</div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-4 text-center">
              <div className="space-y-2">
                ...
                <div className="text-2xl font-bold">0</div>
                <div className="text-xs text-muted-foreground">Obserwowani</div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-4 text-center">
              <div className="space-y-2">
                ...
                <div className="text-2xl font-bold">0</div>
                <div className="text-xs text-muted-foreground">Opinie</div>
              </div>
            </CardContent>
          </Card>
        </div>
              ...
              <div className="space-y-3">
                ...
                {currentUser.website && (
                  <div className="flex items-center gap-3">
                    ...
                    <a href={currentUser.website} className="text-sm text-primary hover:underline" target="_blank" rel="noopener noreferrer">
                      {currentUser.website}
                    </a>
                  </div>
                )}
